...
class Table extends React.PureComponent {
        ...
        <tr className={row.key}>
          <td>
            ...
            <div className='controls'>
              <button className='right' onClick={() => this.removeRow(row.key)}>
                x
              </button>
            </div>
          </td>
  ...
  onGenerateRows = (rows) => {
    this.updateRows([...this.state.rows, ...rows])
  }
    ...
    return (
      <div>
        ...
        <div className='add-row-table-controls'>
          <button className='left' onClick={this.addRow}>
            Add row
          </button>
        </div>
        ...
        {this.state.rows.length > 0 && (
          <div className='right-table-controls'>
            <button className='right' onClick={this.removeRows}>
              Remove rows
            </button>
          </div>
        )}
